...
| 檔案 | 版本 | 視覺 |
|---|---|---|
| `v2.html` | **v2「The Signal」(推薦)** | 台灣大哥大品牌色系(嚴格 HEX):主橘 #F5541E、標題三色漸層(#FFFFFF→#FFB71B→#F5541E)、彩球六色粒子(#FFC20E / #FF8A00 / #F5541E / #E4007F / #7C3AED / #00B5AD)、94% 高潮採品牌桃紅 #E4007F、成果數字湖綠 #00B5AD;高級展示層:頂部聚光、漂浮展示台+光棱線、環繞微粒子、玻璃卡橘色反光邊、Canvas 散景景深、電影感暗角;玻璃態 UI;GSAP 180s 母時間軸(流體轉場、可 scrub);Canvas 粒子場 8 種形態隨劇情變形(星塵漣漪 → 亂流 → 彩色球體聚合 → 資料流 → 紅色爆發 → 管線流 → 塵埃 → 餘燼);Tailwind 編譯後內嵌 |
