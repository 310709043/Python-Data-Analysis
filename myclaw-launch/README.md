...
| 檔案 | 版本 | 視覺 |
|---|---|---|
| `v2.html` | **v2「The Signal」(推薦)** | 台灣大哥大品牌色系:橘為主色,彩球五色(黃/橘/桃紅/紫/湖綠)進粒子系統與吉祥物彩球、紅色只留給 94% 高潮;玻璃態 UI;GSAP 180s 母時間軸(流體轉場、可 scrub);Canvas 粒子場 8 種形態隨劇情變形(星塵漣漪 → 亂流 → 彩色球體聚合 → 資料流 → 紅色爆發 → 管線流 → 塵埃 → 餘燼);Tailwind 編譯後內嵌 |
